...
class Game:
    def __init__(self):
        ...
        self.background_img = pygame.image.load("resources/sprites/background.png").convert()
        ...
        self.neutrophil_anims = {
            'run': pygame.image.load(os.path.join('resources/sprites/male_run.png')).convert_alpha(),
            'punch': pygame.image.load(os.path.join('resources/sprites/male_punch.png')).convert_alpha(),
            'death': pygame.image.load(os.path.join('resources/sprites/male_death.png')).convert_alpha(),
        }

        # Загрузка анимаций для barbarian (для врага)
        self.barbarian_anims = {
            'run': pygame.image.load(os.path.join('resources/sprites/barbarian_run.png')).convert_alpha(),
            'attack': pygame.image.load(os.path.join('resources/sprites/barbarian_attack.png')).convert_alpha(),
        }

        # Загрузка фонового изображения для меню
        self.menu_background_img = pygame.image.load("resources/sprites/menu_background.jpg").convert()
    ...
    def handle_events(self):
        ...
        for event in pygame.event.get():
            ...
            def play_click():
                if self.sounds_on:
                    click_sound = pygame.mixer.Sound("resources/audio/click.mp3")
